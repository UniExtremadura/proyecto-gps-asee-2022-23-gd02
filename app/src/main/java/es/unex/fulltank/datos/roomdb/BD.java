 ...
 */
@Database(entities = {Gasolinera.class, HistorialRepostaje.class, Usuario.class, GasolineraFavorita.class, GasolineraResenha.class, TipoCombustible.class, CombustibleGasolinera.class}, version = 5)
